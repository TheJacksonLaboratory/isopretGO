...
public class HgncParserTest extends TestBase {
    ...
    public void testEnsemblMap() {
        Map<String, HgncItem> ensemblMap = hgncParser.ensemblMap();
        assertEquals(6, ensemblMap.size());
        for (String ens : ensemblMap.keySet()) {
            assertTrue(ens.startsWith("ENSG"));
        }
        assertTrue(ensemblMap.containsKey("ENSG00000121410"));
        assertTrue(ensemblMap.containsKey("ENSG00000268895"));
        assertTrue(ensemblMap.containsKey("ENSG00000166147"));
        assertTrue(ensemblMap.containsKey("ENSG00000177519"));
        assertTrue(ensemblMap.containsKey("ENSG00000124614"));
        assertTrue(ensemblMap.containsKey("ENSG00000160710"));

        // test ENSG00000121410
        HgncItem item = ensemblMap.get("ENSG00000121410");
