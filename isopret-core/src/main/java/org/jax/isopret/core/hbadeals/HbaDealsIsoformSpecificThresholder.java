...
public class HbaDealsIsoformSpecificThresholder {
    ...
    private final Set<HbaDealsTranscriptResult> dasIsoformAccessions;
     ...
     * @param results Map of HBA-DEALS analysis results (key: gene symbol)
     */
    public HbaDealsIsoformSpecificThresholder(Map<String, HbaDealsResult> results, double probThres) {
        rawResults = results;
        ...
        this.dasIsoformAccessions = this.rawResults
                .values()
                .stream()
    ...
    public Set<HbaDealsTranscriptResult> dasIsoformResults() {
        return this.dasIsoformAccessions;
    }
    ...
    public int getDasIsoformCount() {
        return this.dasIsoformAccessions.size();
    }
