...
import org.jax.isopret.core.visualization.OntologyTermVisualizable;
import org.jax.isopret.core.visualization.Visualizable;
import org.jax.isopret.core.visualization.Visualizer;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.util.List;

public class GoSummaryHtmlVisualizer implements Visualizer {
    private static final Logger LOGGER = LoggerFactory.getLogger(GoSummaryHtmlVisualizer.class);
    ...
    public GoSummaryHtmlVisualizer(String experiment) {
